...
export class AppComponent {
	...
	ngOnInit() {
		...
		this.urls = [
			...
			{width: 0, text: 'PRESERVE24', href: 'https://www.urbandaddy.com/articles/23858/new-york/preserve-24-preserve-the-right-a-massive-den-made-of-pianos-and-boats'},
			// {width: 0, text: 'THESTEINWAY', href: 'https://hotpads.com/1-bed-800-sqft-2395-los-angeles-ca-90026-1m2mh4q/pad'},
		];

		this.footerUrls = [
			{width: 0, text: 'contact@\\samanthamink.com', href: 'mailto:contact@samanthamink.com'},
